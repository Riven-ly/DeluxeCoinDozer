...
public class UIManager : MonoBehaviour
{
    ...
    public Transform UIPanelLayer3;

    public Transform uiMask;

    //----effect
    public MachineItemUIEffect machineItemUIEffect;
    public SceneDiamondFlyEffect sceneDiamondFlyEffect;
    //-----
    public MainBtnUI mainBtnUI;
    public PlayInfoUI playInfoUI;
    ...
    /// 每个的数量效果
    /// </summary>
    public void CreatMachineItemUIEffect(Vector3 _objPos, string _str)
    {
        Vector3 screenPos = Camera.main.WorldToScreenPoint(_objPos);
        ...
        machineItemUIEffect.CreatEffect(uiPos.x, _str);
    }

    public void CreatSpecialDiamondEffect(Vector3 _objPos, string _str)
    {
        Vector3 screenPos = Camera.main.WorldToScreenPoint(_objPos);
        RectTransformUtility.ScreenPointToLocalPointInRectangle(
                 UICanvas.GetComponent<RectTransform>(),
        ...
        sceneDiamondFlyEffect.CreatEffect(uiPos.x, _str);
    }
